                ...
                <Box key={userShow.tvShow?.tmdbId} className="show-card-wrapper">
                  <ContentCard
                    item={{
                      ...
                      // Remove name property as it doesn't exist in ContentItem interface
                      overview: userShow.tvShow?.overview || undefined,
                      posterPath: userShow.tvShow?.posterPath || undefined,
                      backdropPath: userShow.tvShow?.backdropPath || undefined,
